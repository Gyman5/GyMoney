Contributing to GyMoney Core
============================

The GyMoney Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GyMoney Core project, and is not to be
confused with overall GyMoney Network Protocol consensus changes.

Whether a pull request is merged into GyMoney Core rests with the project merge
...
Patches that change GyMoney consensus rules are considerably more involved than
...
Where a patch set proposes to change the GyMoney consensus, it must have been
...
The project leader is the release manager for each GyMoney Core release.
