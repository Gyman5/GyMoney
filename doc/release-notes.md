GyMoney Core version 2.2.1 is now available from:

  <https://github.com/GyMoney-project/GyMoney/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/GyMoney-project/GyMoney/issues>

Compatibility
==============

GyMoney Core is extensively tested on multiple operating systems using
...
GyMoney Core should also work on most other Unix-like systems but is not
...
of Bitcoin that GyMoney was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/GyMoney-project-translations/).
