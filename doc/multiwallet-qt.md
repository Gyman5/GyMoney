...
In order to support loading of multiple wallets in GyMoney-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is GyMoney.cpp.
...
Changes to GyMoney.cpp
----------------------
GyMoney.cpp is the entry point into GyMoney-qt, and as such, will require some minor modifications to provide hooks for
