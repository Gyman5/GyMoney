...
/** Utility functions used by the GyMoney Qt UI.
 */
namespace GUIUtil
{
...
// Render GyMoney addresses in monospace font
...
// Parse "GyMoney:" URI into recipient object, return true on successful parsing
