                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GyMoney Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GyMoney address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GyMoney: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GyMoney Core"), this);
    aboutAction->setStatusTip(tr("Show information about GyMoney Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GyMoney"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GyMoney addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GyMoney addresses"));
    ...
    openAction->setStatusTip(tr("Open a GyMoney: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GyMoney Core help message to get a list with possible GyMoney command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GyMoney Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GyMoney network", "", count));
}
...
{
    QString strTitle = tr("GyMoney Core"); // default title
