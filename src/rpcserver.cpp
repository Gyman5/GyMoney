...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "GyMoney server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GyMoney features */
        {"GyMoney", "masternode", &masternode, true, true, false},
        {"GyMoney", "masternodelist", &masternodelist, true, true, false},
        {"GyMoney", "mnbudget", &mnbudget, true, true, false},
        {"GyMoney", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"GyMoney", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"GyMoney", "mnsync", &mnsync, true, true, false},
        {"GyMoney", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"GyMoney", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use GyMoneyd, or the -server option to GyMoney-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> GyMoney-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17665/\n";
}
