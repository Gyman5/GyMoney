...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GyMoney Core GyMoney-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  GyMoney-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded GyMoney transaction") + "\n" +
                               "  GyMoney-tx [options] -create [commands]   " + _("Create hex-encoded GyMoney transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded GyMoney transaction
