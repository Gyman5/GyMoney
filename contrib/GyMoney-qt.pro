...
RESOURCES += src/qt/GyMoney.qrc src/qt/GyMoney_locale.qrc

TRANSLATIONS += src/qt/locale/GyMoney_bg.ts \
                src/qt/locale/GyMoney_de.ts \
                src/qt/locale/GyMoney_en.ts \
                src/qt/locale/GyMoney_es.ts \
                src/qt/locale/GyMoney_fi.ts \
                src/qt/locale/GyMoney_fr.ts \
                src/qt/locale/GyMoney_it.ts \
                src/qt/locale/GyMoney_ja.ts \
                src/qt/locale/GyMoney_pl.ts \
                src/qt/locale/GyMoney_pt.ts \
                src/qt/locale/GyMoney_ru.ts \
                src/qt/locale/GyMoney_sk.ts \
                src/qt/locale/GyMoney_sv.ts \
                src/qt/locale/GyMoney_vi.ts \
                src/qt/locale/GyMoney_zh_CN.ts \
                src/qt/locale/GyMoney_zh_TW.ts
